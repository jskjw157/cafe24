...
# Set up the Linear integration
  ...
  1. Set up [Codex cloud tasks](/codex/cloud) by connecting GitHub at <https://chatgpt.com/codex> and creating an [environment](/codex/cloud/environments) for the repository you want Codex to work in.
