...
**검증 방법:**
1. `docs/화면_정의서.md`에서 화면 ID, 기능 목록 추출
2. `docs/데이터베이스_정의서.md`에서 테이블별 활용 화면 주석 추출
...
**검증 방법:**
1. `docs/프로젝트_기획서.md`에서 핵심 기능 목록 추출
2. `docs/화면_정의서.md`에서 화면별 주요 기능 추출
3. 기능 ↔ 화면 매핑 확인
...
**검증 방법:**
1. `docs/mvp/mvp_API_계약.md`에서 API 엔드포인트 추출
...
| API 계약서 | `docs/mvp/mvp_API_계약.md` |
