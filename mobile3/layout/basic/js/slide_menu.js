...
$(function(){
        ...
        show: function(overNode, iCateNo) {
            ...
            if (methods.aSubCategory[iCateNo] != undefined) {
                ...
                $(methods.aSubCategory[iCateNo]).each(function() {
                    ...
                    if (methods.aSubCategory[sNextParentNo] != undefined)  aHtml.push('<a href="/product/list_thumb.html'+this.param+'" class="view">商品を見る</a>');
                    aHtml.push('<button type="button" class="icoBookmark'+sCateSelected+'" id="icoBookmark">お気に入りに追加</button>');
            ...
            if (sMyCateList != null && sMyCateList != "") {
                ...
                for (var i = 0; i < aTempList.length; i++) {
                    if (aTempList[i] != "") {
                        ...
                        aHtml.push('<li id="bookmark'+iCateNo+'"><a href="/product/list_thumb.html'+sCateParam+'" book_mark="'+iCateNo+'">'+sCateName+'</a><button type="button" class="icoBookmark selected" onclick="setMyCateList('+iCateNo+');">お気に入り削除</button></li>');
    ...
    var offCover = {
        init : function() {
            $(function() {
               $('#wrap').append('<a href="#container" id="btnFoldLayout">開く</a>');
                offCover.resize();
...
function setMyCateList(iCateNo, oObj) {
    ...
    if (checkInArray(sMyCateList, iCateNo) == true) {
        ...
        var sHtml = '';
        if (sMyCateList == null || sMyCateList == '') {
            sHtml = '<ul><li id="bookmark'+iCateNo+'"><a href="/product/list_thumb.html'+sCateParam+'" book_mark="'+iCateNo+'">'+sCateName+'</a><button type="button" class="icoBookmark selected" onclick="setMyCateList('+iCateNo+');">お気に入り削除</button></li></ul>'
            $('#bookmarkCategory #bookmartCateArea').append(sHtml);
        } else {
            sHtml = '<li id="bookmark'+iCateNo+'"><a href="/product/list_thumb.html'+sCateParam+'" book_mark="'+iCateNo+'">'+sCateName+'</a><button type="button" class="icoBookmark selected" onclick="setMyCateList('+iCateNo+');">お気に入り削除</button></li>'
