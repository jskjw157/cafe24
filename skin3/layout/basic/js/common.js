...
$(function(){
    ...
    $('.xans-product-listmain h2').on('click', function() {
        ...
        var sUrl;
        if (bClosed) {
            sUrl = "//img.echosting.cafe24.com/skin/mobile_ja_JP/layout/bg_title_close.gif";
        } else {
            sUrl = "//img.echosting.cafe24.com/skin/mobile_ja_JP/layout/bg_title_open.gif";
        }
    ...
    if (this.url) {
        ...
        $.ajax({
            ...
            success : function (data) {
                if (data.indexOf('404エラー  ページが見つかりません。') == -1) {
