$(function(){
    ...
    var fixedLayerPriceSet = function() {
        ...
        if (iCheckPrdCnt > 0) {
            ...
            $('#checked_order_count').html('<strong>' + sprintf(__('%s'),iCheckPrdCnt) + '</strong>' +'点の商品選択').css('padding-bottom','5px');
            $('#checked_order_price').html('決済予定金額 <strong><em><span id="checked_total_order_price">'+sTotalPrice+'</span></em></strong>').css('padding-bottom','5px');
